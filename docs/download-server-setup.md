...
```json
{
  ...
  "downloads": {
    "linux-x86_64": {
      "url": "http://72.60.125.7/latest/phonehome-linux-x86_64.tar.gz",
      "sha256": "abc123...",
      "size": 45000000
    },
    "linux-aarch64": {
      "url": "http://72.60.125.7/latest/phonehome-linux-aarch64.tar.gz",
      "sha256": "def456...",
      "size": 44000000
    },
    "windows-amd64": {
      "url": "http://72.60.125.7/latest/phonehome-windows-amd64.zip",
      "sha256": "ghi789...",
      "size": 50000000
    }
  },
...
```bash
curl -O http://72.60.125.7/latest/phonehome-linux-x86_64.tar.gz
# or
wget http://72.60.125.7/latest/phonehome-linux-x86_64.tar.gz
```

### Windows (PowerShell)

```powershell
Invoke-WebRequest -Uri http://72.60.125.7/latest/phonehome-windows-amd64.zip -OutFile phonehome.zip
# or
Start-BitsTransfer -Source http://72.60.125.7/latest/phonehome-windows-amd64.zip -Destination phonehome.zip
```

### Check Latest Version

```bash
curl http://72.60.125.7/latest/version.json
```
